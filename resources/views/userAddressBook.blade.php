            ...
            <div class="col-md-8 border-right">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Address Book</h4>
                        <a href="/userAddress/create"><button type="button" class="btn btn-outline-primary"><i
                                ...
                                @foreach ($addresses as $address)
                                    <tr>
                                        <td style="max-width: 150px;">
                                            ...
                                            <p>
                                                {{ $address->addressNo . ', ' . $address->addressOne . ' ' . $address->addressTwo . ' ' . $address->addressThree }}
                                            </p>
                                        </td>
                                        <td style="max-width: 150px;">
                                            <p>
                                        ...
                                        <td style="max-width: 100px;">
                                            <a href="/userAddress/{{ $address->id }}"><button

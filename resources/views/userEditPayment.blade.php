        ...
        <div class="row">
            ...
            <div class="col-md-8 border-right">
                <div class="p-3 py-5">
                    ...
                    <form method="POST" action="/payMethod/{{ $id }}">
                        @csrf
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <label class="labels">Give a name to this payment</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    placeholder="eg: personal account" name="name" value="{{ $payMethod->paymentName }}">
                                @error('name')
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('cardno') is-invalid @enderror"
                                    placeholder="card number" name="cardno" value="{{ $payMethod->cardNo }}">
                                @error('cardno')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="company" aria-label="Default select example" required>
                                    <option value="{{ $payMethod->paymentCompany }}" selected>
                                        {{ $payMethod->paymentCompany }} (Current)</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="expiryM" aria-label="Default select example" required>
                                    <option value="{{ $payMethod->cardMExpiry }}" selected>{{ $payMethod->cardMExpiry }}
                                        (Current)</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="expiryY" aria-label="Default select example" required>
                                    <option value="{{ $payMethod->cardYExpiry }}" selected>{{ $payMethod->cardYExpiry }}
                                        (Current)</option>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-2">
                                ...
                                <input type="number" min="100" max="999" step="1"
                                    class="form-control @error('cvv') is-invalid @enderror" placeholder="cvv"
                                    name="cvv" value="{{ $payMethod->cardCVV }}">
                                @error('cvv')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>

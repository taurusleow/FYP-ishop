    ...
    <header>
        <div id="sideNavBar" class="sideNavBar">
            <div id="fontMenu">
                ...
                <a href="/merchantProducts">Products</a>
                <a href="/merchantOrders">Order</a>
                <a href="/merchantRefundRequest">Return and Refund</a>
                <a href="/merchantReports">Report</a>
                <a href="/merchantProfile">Profile</a>
            </div>
            <div id="iconMenu">
                <a href="javascript:void(0)" id="openBtn" class="openBtn" onclick="openNavBar()"><i
                        class="fa-solid fa-bars"></i></a>
                <a href="/merchantProducts"><i class="fa-solid fa-box"></i></a>
                <a href="/merchantOrders"><i class="fa-solid fa-list"></i></a>
                <a href="/merchantRefundRequest"><i class="fa-sharp fa-solid fa-rotate-left"></i></a>
                <a href="/merchantReports"><i class="fa-solid fa-flag"></i></a>
                <a href="/merchantProfile"><i class="fa-solid fa-user"></i></a>
            </div>

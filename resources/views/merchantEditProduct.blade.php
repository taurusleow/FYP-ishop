...
@section('content')
    ...
    <div class="row" style="width: 100%;">
        <div class="col-md-max">
            <form id="msform" action="/merchantEditProducts/{{ $id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- progressbar -->
                <ul id="progressbar">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('productname') is-invalid @enderror"
                                    id="floatingInput" name="productname" value="{{ $product[0]->productName }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <select class="form-select" id="category" name="category"
                                    ...
                                    <option value="{{ $product[0]->category }}" selected>{{ $product[0]->category }}
                                        (Current)</option>
                        ...
                        <div class="col-md-12">
                            <div class="form-floating">
                                <textarea class="form-control @error('productDescription') is-invalid @enderror" placeholder="product description"
                                    name="productDescription" id="floatingTextarea2" style="height: 100px;">{{ $product[0]->productDesc }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input id="price" type="number" step="0.01"
                                    ...
                                    value="{{ $product[0]->productPrice }}" required>
                ...
                <fieldset>
                    ...
                    <div class="row mt-2" style="margin-bottom: 10px;">
                        <div class="col-md-3">
                            <img id="img1" src="/productImg/{{ $product[0]->image1 }}" width="100px"
                                alt="Product Image" />
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row mt-2" style="margin-bottom: 10px;">
                        <div class="col-md-3">
                            <img id="img2" src="/productImg/{{ $product[0]->image2 }}" width="100px"
                                alt="Product Image" />
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row mt-2" style="margin-bottom: 10px;">
                        <div class="col-md-3">
                            <img id="img3" src="/productImg/{{ $product[0]->image3 }}" width="100px"
                                alt="Product Image" />
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row mt-2" style="margin-bottom: 10px;">
                        <div class="col-md-3">
                            <img id="img4" src="/productImg/{{ $product[0]->image4 }}" width="100px"
                                alt="Product Image" />
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row mt-2" style="margin-bottom: 10px;">
                        <div class="col-md-3">
                            <img id="img5" src="/productImg/{{ $product[0]->image5 }}" width="100px"
                                alt="Product Image" />
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row mt-2" style="margin-bottom: 10px;">
                        <div class="col-md-3">
                            <img id="img6" src="/productImg/{{ $product[0]->image6 }}" width="100px"
                                alt="Product Image" />
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row mt-2" style="margin-bottom: 10px;">
                        <div class="col-md-3">
                            <img id="img7" src="/productImg/{{ $product[0]->image7 }}" width="100px"
                                alt="Product Image" />
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row mt-2" style="margin-bottom: 10px;">
                        <div class="col-md-3">
                            <img id="img8" src="/productImg/{{ $product[0]->image8 }}" width="100px"
                                alt="Product Image" />
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row mt-2" style="margin-bottom: 10px;">
                        <div class="col-md-3">
                            <img id="img9" src="/productImg/{{ $product[0]->image9 }}" width="100px"
                                alt="Product Image" />
                        </div>
                        <div class="col-md-9">
                ...
                <fieldset>
                    ...
                    <div class="row mt-2" style="margin-bottom: 10px;">
                        <div class="col-md-12">
                            <label for="document" class="form-label" style="float: left;">Supporting Document (PDF
                                only)</label>
